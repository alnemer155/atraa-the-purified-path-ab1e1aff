// Static list of the 114 surahs (Arabic name + ayah count) for selectors.
...
export const SURAHS: SurahEntry[] = [
  ...
  { number: 106, name: 'الماعون' },
  { number: 107, name: 'الكوثر' },
  { number: 108, name: 'الكافرون' },
  { number: 109, name: 'النصر' },
  { number: 110, name: 'المسد' },
  { number: 111, name: 'الإخلاص' },
  { number: 112, name: 'الفلق' },
  { number: 113, name: 'الناس' },
