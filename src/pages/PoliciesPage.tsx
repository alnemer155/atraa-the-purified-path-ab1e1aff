    ...
    <div className="px-4 py-4 space-y-3 animate-fade-in">
      ...
      <Section icon={Bot} title="سياسة استخدام الذكاء الاصطناعي">
        ...
        <Item title="دقة المعلومات">
          الإجابات مولّدة بالذكاء الاصطناعي وقد تحتوي على أخطاء أو معلومات غير دقيقة. يجب التحقق من المصادر الأصلية والرجوع إلى العلماء والمراجع المعتمدة.
        </Item>
        <Item title="المصادر">
      ...
      <Section icon={Trophy} title="شروط مسابقة عِتَرَةً">
        ...
        <Item title="الأسئلة والذكاء الاصطناعي">
          الأسئلة مولّدة بالذكاء الاصطناعي وقد تحتوي أخطاء. المشارك يتحمل مسؤولية التحقق من صحة المعلومات.
        </Item>
