      ...
      {isAr ? (
        <>
          ...
          <section>
            ...
            <p>منصة إسلامية تقدّم محتوى دينياً منظماً وحديثاً: أوقات الصلاة، أدعية، زيارات، أذكار، تسبيح، القرآن الكريم، واتجاه القبلة.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="tabular-nums">v2.10.60.20 · بناء 361</p>
          </section>
          <section>
        ...
        <>
          ...
          <section>
            ...
            <p className="tabular-nums">v2.10.60.20 · build 361</p>
          </section>
          <section>
